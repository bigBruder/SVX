...
import { registWithEmailAndPassword } from "../../api/firebase/registration";
        ...
        >
          ...
          >
            <Grid container spacing={2}>
              ...
              {authStatus.message && (
                <Grid item xs={12}>
                  <Alert> {authStatus.message} </Alert>
                </Grid>
              )}
              <Grid item xs={12}>
                <FormControlLabel
            ...
            <EmailAuthButton
              bthMessage="Sign up by Google account"
              onAuthResultMessage="User was registrated"
