...
const StyledAlert = () => {
  return (
    <Alert severity="info">
      Ihre Reserven sorgen für Deckung Ihrer laufenden Ausgaben im Falle
      unvorhergesehener Ereignisse Sie sollten sofort verfügbar und nicht Teil
      Ihrer Kapitalmarktanlage sein.
    </Alert>
  );
};
